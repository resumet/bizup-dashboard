    ...
    <Card>
      ...
      <CardContent className="space-y-5">
        ...
        {!loading && !error && <>
          ...
          <p className="text-xs leading-5 text-muted-foreground">—는 미입력 또는 분모 0입니다. 전환율은 라이브 시작 인원과 결제 건수 기준이며 고유 구매자 비율과 다를 수 있습니다. 소통방 인원은 단톡방에 합산하지 않습니다. 최대 도달 시간은 라이브 시작부터의 경과 시간입니다.</p>
